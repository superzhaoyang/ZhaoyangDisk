...
{
    ui->label->setText(LoginInfoInstance::getInstance()->getUser() );
    if(LoginInfoInstance::getInstance()->getUser() == "zhaoyang")
        ui->label_2->setStyleSheet("border-image: url(:/images/avatar.jpg);border-radius:15px;");
    else
        ui->label_2->setStyleSheet("border-image: url(:/images/life.jpg);border-radius:15px;");
